...
export type ChunkRenderingShader = {
...
export const CoreVoxelRenderingShader = {
     ...
     */
    wrapLoadedVoxelProgram(gl: GlCtx, program: WebGLProgram): ChunkRenderingShader {
        return {
            program,
     ...
     */
    loadDefaultVoxelShader(gl: GlCtx): OptionalReasoned<ChunkRenderingShader> {
